...
const Footer: React.FC<FooterProps> = ({ footer, lang }) => {
  return (
    <>
      ...
      <div className="w-screen bg-[#463880] 	overflow-x-hidden ">
        <div className="2xl:w-[1325px] 2xl:mx-auto 2xl:px-0 md:flex block md:px-4 px-2 lg:px-16 py-14 md:justify-between text-white">
